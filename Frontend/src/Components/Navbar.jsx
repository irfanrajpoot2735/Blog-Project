...
export default function Navbar() {
  ...
  return (
    ...
    <nav className="navbar d-flex justify-content-between   align-items-center p-3">
       ...
       <Link to={'/'}>
      <h1 className="mx-5 text-white fs-2 fw-bold">Blog-App Project</h1>
    </Link> 
    ...
    {/* Added Navbar Links */}
    <Link to="/" className="mx-3 text-white fs-5">Home</Link>
    <Link to="/About" className="mx-3 text-white fs-5">About</Link>
    <Link to="/Contact" className="mx-3 text-white fs-5">Contact</Link>
